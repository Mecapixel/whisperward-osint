...
# Aggressive warning suppression for HF Hub
warnings.filterwarnings("ignore", message=".*unauthenticated.*")
warnings.filterwarnings("ignore", message=".*HF Hub.*token.*")
...
class RAGEngine:
    ...
    def add_case_data(self, case_id: str, target_id: int, documents: list, metadata: dict = None):
        ...
        print(f"    ✅ RAG: Added {len(documents)} documents for case {case_id}")
